<!-- FILE PHP PER GENERARE LE INFO SULLE PRENOTAZIONI DI UN DETERMINATO UTENTE -->
...
<?php
        ...
        echo '<div class="accordion-item">';
            ...
            echo '<div id="prenotazione_'.$IDPrenotazione.'" class="accordion-collapse collapse" data-bs-parent="#Prenotazioni">';
                echo '<div class="accordion-body">';
                    ...
                    //<strong>STRONG</strong> TESTO <code> int main(){} </code>
                    ...
                    echo '<div class="card">';
                        ...
                        echo '<div class="card-body">';
                            //echo '<h5 class="card-title"> ID PRENOTAZIONE #'.$reserv["IDPrenotazione"].'</h5>';
                            echo '<p class="card-text"><strong> HAI EFFETTUATO LA PRENOTAZIONE NEL GIORNO: '.$reserv["DataOraAvvenutaPrenotazione"].'</strong></p>';
                        ...
                        echo '<div class="card-footer">';
                            echo '<p class="card-text"><strong>HAI SPESO: '.$reserv["CostoTotale"].' &euro;</strong></p>';
                        echo '</div>';
                        echo '<div class="card-body">';
    ...
    if( $result = $connessione->query($selectPrenotazioni) ) {    
        ...
        header("location:userReservation.php?error=Errore in fase di recupero dei dati prenotazione");
        exit();
    }
